...
local rLocaleId = localizationService.RobloxLocaleId;
...
local translationVector2 = {[0]={code="en",locale="en-us",translated="Your version (%s) of Roblox is out of date and will not work properly. Please update it at Delta's website: https://deltaexploits.net/android"},[1]={code="hi",locale="hi-in",translated="Roblox का आपका संस्करण (%s) पुराना है और ठीक से काम नहीं करेगा।कृपया इसे डेल्टा की वेबसाइट पर अपडेट करें: https://deltaexploits.net/android"},[2]={code="zh",locale="zh-cn",translated="您的Roblox版本（%s）已过时，无法正常工作。请在Delta的网站上进行更新：https：//deltaexploits.net/android"},[3]={code="es",locale="es-es",translated="Su versión (%s) de Roblox está desactualizada y no funcionará correctamente.Actualizarlo en el sitio web de Delta: https://deltaexploits.net/android"},[4]={code="vi",locale="vi-vn",translated="Phiên bản của bạn (%s) của Roblox đã lỗi thời và sẽ không hoạt động đúng.Vui lòng cập nhật nó tại trang web của Delta: https://deltaexploits.net/android"},[5]={code="id",locale="id-id",translated="Versi Anda (%s) dari Roblox sudah ketinggalan zaman dan tidak akan berfungsi dengan baik.Harap perbarui di situs web Delta: https://deltaexploits.net/android"},[6]={code="el",locale="el-gr",translated="Η έκδοση σας (%s) του Roblox είναι ξεπερασμένη και δεν θα λειτουργήσει σωστά.Ενημερώστε το στην ιστοσελίδα της Delta: https://deltaexploits.net/android"},[7]={code="da",locale="da-dk",translated="Din version (%s) af Roblox er forældet og fungerer ikke korrekt.Opdater det på Delta's websted: https://deltaexploits.net/android"},[8]={code="tl",locale="tl-ph",translated="Ang iyong bersyon (%s) ng Roblox ay wala sa oras at hindi gagana nang maayos.Mangyaring i -update ito sa website ng Delta: https://deltaexploits.net/android"},[9]={code="sv",locale="sv-se",translated="Din version (%s) av Roblox är föråldrad och fungerar inte korrekt.Uppdatera den på Deltas webbplats: https://delaexploits.net/android"},[10]={code="ko",locale="ko-kr",translated="Roblox의 버전 (%s)은 구식이 아니며 제대로 작동하지 않습니다.델타 웹 사이 트 https://deltaexploits.net/android에서 업데이트하십시오"},[11]={code="pl",locale="pl-pl",translated="Twoja wersja (%s) Roblox jest nieaktualna i nie będzie działać poprawnie.Zaktualizuj go na stronie internetowej Delta: https://deltaexploits.net/android"},[12]={code="ru",locale="ru-ru",translated="Ваша версия (%s) Roblox устарела и не будет работать должным образом.Пожалуйста, обновите его на веб -сайте Delta: https://deltaexploits.net/android"},[13]={code="ja",locale="ja-jp",translated="Robloxのバージョン（%s）は時代遅れであり、適切に機能しません。DeltaのWeb サイトhttps://deltaexploits.net/androidで更新してください"},[14]={code="nl",locale="nl-nl",translated="Uw versie (%s) van Roblox is verouderd en werkt niet goed.Werk het bij op de website van Delta: https://deltaexploits.net/android"},[15]={code="ms",locale="ms-my",translated="Versi anda (%s) Roblox sudah ketinggalan zaman dan tidak akan berfungsi dengan baik.Sila kemas kini di laman web Delta: https://deltaexploits.net/android"},[16]={code="pt",locale="pt-br",translated="Sua versão (%s) do Roblox está desatualizada e não funcionará corretamente.Atualize -o no site da Delta: https://deltaexploits.net/android"},[17]={code="tr",locale="tr-tr",translated="Roblox'un sürümünüz (%s) güncel değil ve düzgün çalışmayacak.Lütfen Delta'nın web sitesinde güncelleyin: https://deltaexploits.net/android"},[18]={code="hu",locale="hu-hu",translated="A Roblox verziója (%s) elavult, és nem fog megfelelően működni.Kérjük, frissítse a Delta weboldalán: https://deltaexploits.net/android"},[19]={code="fi",locale="fi-fi",translated="Robloxin versio (%s) on vanhentunut eikä toimi kunnolla.Päivitä se Delta -verkkosivustolla: https://deltaexploits.net/android"},[20]={code="de",locale="de-de",translated="Ihre Version (%s) von Roblox ist veraltet und funktioniert nicht ordnungsgemäß.Bitte aktualisieren Sie es auf der Website von Delta: https://deltaexploits.net/android"},[21]={code="th",locale="th-th",translated="เวอร์ชันของคุณ (%s) ของ Roblox ล้าสมัยและจะทำงานไม่ถูกต้องโปรดอัปเดตที่เว          ว็บไซต์ของ Delta: https://deltaexploits.net/android"},[22]={code="ar",locale="ar-sa",translated="نسختك (%s) من Roblox قديمة ولن تعمل بشكل صحيح.يرجى تحديثه على موقع Delta على الويب: https://deltaexploits.net/android"},[23]={code="cs",locale="cs-cz",translated="Vaše verze (%s) ROBLOX je zastaralá a nebude fungovat správně.Aktualizujte ji na webových stránkách Delta: https://deltaexploits.net/android"},[24]={code="zh",locale="zh-tw",translated="您的Roblox版本（%s）已過時，無法正常工作。請在Delta的網站上進行更新：https：//deltaexploits.net/android"},[25]={code="it",locale="it-it",translated="La tua versione (%s) di Roblox è obsole e non funzionerà correttamente.Aggiornalo sul sito web di Delta: https://deltaexploits.net/android"}}
